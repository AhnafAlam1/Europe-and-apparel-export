...
###Note: The code below is an copy of the original paper by . with few minor tweaks.
...
write_csv(ldc22, "outputs/data/ldc_data.csv")
write_csv(bgd1, "outputs/data/bgd.csv")
write_csv(cbda1, "outputs/data/cbda.csv")
write_csv(nep1, "outputs/data/nep.csv")
